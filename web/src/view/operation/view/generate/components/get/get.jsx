...
export default class Get extends Component{
    ...
    getChallenge = () => {
        //点击生成新的challenge和配置位
        let pufas = document.getElementById('pufa-s');
        let pufac = document.getElementById('pufa-c');
        let pufbs = document.getElementById('pufb-s');
        let pufbc = document.getElementById('pufb-c');
